...
STORE1='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1578502494516-5c50e83e8f30?w=400&q=80"}
}'
post_entity "$STORE1"
...
STORE2='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1577720643272-265dc0b37a21?w=400&q=80"}
}'
post_entity "$STORE2"
...
STORE3='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=400&q=80"}
}'
post_entity "$STORE3"
...
EMP4='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&q=80"}
}'
post_entity "$EMP4"
...
PROD1='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&q=80"}
}'
post_entity "$PROD1"
...
PROD2='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1545459720-26a19c0a01bf?w=400&q=80"}
}'
post_entity "$PROD2"
...
PROD6='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=400&q=80"}
}'
post_entity "$PROD6"
...
PROD8='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1556656793-08538906a9f8?w=400&q=80"}
}'
post_entity "$PROD8"
...
PROD9='{
  ...
  "image": {"type": "Text", "value": "https://images.unsplash.com/photo-1621905167918-48416bd8575a?w=400&q=80"}
}'
post_entity "$PROD9"
