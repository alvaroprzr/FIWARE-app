...
const i18n = {
    es: {
        ...
        'store.edit_inventory_title': 'Inventario en esta Shelf',
        'store.edit_inventory_help': 'Puedes ajustar el shelfCount por producto.',
        ...
        'map.relative_humidity': 'Humedad relativa',
        'table.image': 'Imagen',
        'table.name': 'Nombre',
        'table.country': 'País',
        'table.temperature': 'Temperatura',
        'table.humidity': 'Humedad',
        'table.shelves_count': '# Estanterías',
        'table.price': 'Precio',
        'table.size': 'Tamaño',
        'table.color': 'Color',
        ...
        'product.units_in_stock': 'Unidades en Stock',
        'common.not_available': 'N/A',
        'form.id': 'ID',
        'form.name': 'Nombre',
        'form.price': 'Precio',
        'form.size': 'Tamaño',
        'form.select_size': '-- Seleccionar tamaño --',
        'form.color': 'Color',
        'form.image': 'URL de Imagen',
        'form.cancel': 'Cancelar',
        'form.create': 'Crear',
        'form.id_help': 'Solo caracteres alfanuméricos y guiones',
        'form.preview': 'Vista previa:',
        'form.creating_product': 'Creando producto...',
        'form.product_created_redirect': 'Producto creado exitosamente. Redirigiendo...',
        'form.product_updated_redirect': 'Producto actualizado correctamente. Redirigiendo...',
        'form.product_created_redirect_short': 'Producto creado correctamente. Redirigiendo...',
        'form.connection_error': 'Error de conexion: {error}',
        'form.size_other_required': 'Debes indicar un tamaño cuando seleccionas Otro.',
        'error.title': 'Error',
    ...
    en: {
        ...
        'store.table.stock': 'stockCount',
        'store.table.shelf': 'shelfCount',
        'store.edit_inventory_title': 'Inventory in this shelf',
        'store.edit_inventory_help': 'You can adjust shelfCount by product.',
        ...
        'map.title': 'Stores Map',
        'map.unknown_store': 'Unknown store',
        'map.unknown_locality': 'Unknown locality',
        'map.capacity_label': 'Capacity',
        'map.country_code': 'CountryCode',
        'map.temperature': 'Temperature',
        'map.relative_humidity': 'Relative humidity',
        'table.image': 'Image',
        'table.name': 'Name',
        'table.country': 'Country',
        'table.temperature': 'Temperature',
        'table.humidity': 'Humidity',
        'table.shelves_count': '# Shelves',
        'table.price': 'Price',
        'table.size': 'Size',
        'table.color': 'Color',
        ...
        'product.units_in_stock': 'Stock units',
        'common.not_available': 'N/A',
        'form.id': 'ID',
        'form.name': 'Name',
        'form.price': 'Price',
        ...
        'form.cancel': 'Cancel',
        'form.create': 'Create',
        'form.id_help': 'Only alphanumeric characters and hyphens',
        'form.preview': 'Preview:',
        'form.creating_product': 'Creating product...',
        'form.product_created_redirect': 'Product created successfully. Redirecting...',
        'form.product_updated_redirect': 'Product updated successfully. Redirecting...',
        'form.product_created_redirect_short': 'Product created successfully. Redirecting...',
        'form.connection_error': 'Connection error: {error}',
        'form.size_other_required': 'You must provide a size when selecting Other.',
        'error.title': 'Error',
